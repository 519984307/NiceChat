...
static ::_pb::Metadata file_level_metadata_friends_2eproto[1];
...
const uint32_t TableStruct_friends_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::im::proto::Friends, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::im::proto::Friends, _impl_.users_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::im::proto::Friends)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::im::proto::_Friends_default_instance_._instance,
};

const char descriptor_table_protodef_friends_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rfriends.proto\022\010im.proto\032\nuser.proto\"(\n"
  "\007Friends\022\035\n\005users\030\001 \003(\0132\016.im.proto.UserB"
  "%\n\025com.zhuzichu.protocolB\014FriendsProtob\006"
  "proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_friends_2eproto_deps[1] = {
...
const ::_pbi::DescriptorTable descriptor_table_friends_2eproto = {
    false, false, 126, descriptor_table_protodef_friends_2eproto,
    "friends.proto",
    &descriptor_table_friends_2eproto_once, descriptor_table_friends_2eproto_deps, 1, 1,
...
Friends::Friends(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:im.proto.Friends)
}
Friends::Friends(const Friends& from)
  ...
  // @@protoc_insertion_point(copy_constructor:im.proto.Friends)
}
...
Friends::~Friends() {
  // @@protoc_insertion_point(destructor:im.proto.Friends)
...
void Friends::Clear() {
// @@protoc_insertion_point(message_clear_start:im.proto.Friends)
...
uint8_t* Friends::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:im.proto.Friends)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:im.proto.Friends)
  return target;
}

size_t Friends::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:im.proto.Friends)
  size_t total_size = 0;
...
void Friends::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:im.proto.Friends)
...
// @@protoc_insertion_point(class_specific_copy_from_start:im.proto.Friends)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::im::proto::Friends*
Arena::CreateMaybeMessage< ::im::proto::Friends >(Arena* arena) {
  return Arena::CreateMessageInternal< ::im::proto::Friends >(arena);
}
